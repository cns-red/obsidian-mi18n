...
const zhCN: MessagesShape = {
  ...
  notice: {
    ...
    clipboard_read_error: "读取剪贴板失败。",
    translate_empty_note: "无法翻译没有语言块的笔记。",
    context_too_small: "上下文窗口相对于输出上限太小。请增大上下文上限或减小输出上限。",
    translate_chunk_failed: "第 {current}/{total} 段翻译失败",
    translate_chunk_failed_notice: "第 {current} 段翻译重试 3 次后仍失败。",
    translate_progress: "翻译中... 已完成 {done}/{total} 段，共 {chars} 字",
    export_no_block: "未找到 {label} 语言块，仅导出共享内容。",
  },
  settings: {
    title: "mi18n — 设置",
    ...
    ai_api_company_desc: "选择 AI 服务提供商。OpenAI 使用标准 /chat/completions 接口，Anthropic 使用 /messages 接口。",
    ...
    ai_max_context_desc: "模型的总上下文大小（token）。超出此长度的文本会自动分片翻译。",
    ai_max_tokens_name: "单次输出上限",
    ai_max_tokens_desc: "模型每次最多生成的 token 数。",
    ai_timeout_name: "请求超时（秒）",
    ai_timeout_desc: "每片翻译的最大等待秒数。模型较慢或输出较长时请增大。",
    ai_concurrency_name: "并发切片数",
    ai_concurrency_desc: "同时翻译的切片数量。越高越快，但可能触发 API 限流。默认 2，最大 10。",
    ai_system_prompt_name: "System Prompt / 系统提示词",
    ai_system_prompt_desc: "发送给模型的底层设定指令。如果你发现翻译格式经常出错，可以在这里微调规则。",
    section_scope: "作用范围",
    section_scope_desc: "限定插件生效的 Vault 目录，排除目录优先级高于工作目录。",
    scope_work_dirs_name: "工作目录",
    scope_work_dirs_hint: "仅在列出的目录内生效，空列表 = 全部文件。",

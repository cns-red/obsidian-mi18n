const hi = {
    ...
    settings: {
        ...
        override_inline_title_name: "फ्रंटमैटर से नोट शीर्षक ओवरराइड करें",
        override_inline_title_desc:
            "सक्षम होने पर, title फ़ील्ड वाले नोट फ़ाइल नाम के बजाय frontmatter मान दिखाएंगे। अन्य भाषाओं के लिए title_<कोड> (जैसे title_en) उपयोग करें।",
